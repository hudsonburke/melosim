...
#define LOW_PRECISION`),e}function _d(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Za?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Ho?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===jt&&(e="SHADOWMAP_TYPE_VSM"),e}function gd(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case $n:case jn:e="ENVMAP_TYPE_CUBE";break;case sr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function vd(i){let e="ENVMAP_MODE_REFLECTION";return i.envMap&&i.envMapMode===jn&&(e="ENVMAP_MODE_REFRACTION"),e}function xd(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case $a:e="ENVMAP_BLENDING_MULTIPLY";break;case sl:e="ENVMAP_BLENDING_MIX";break;case al:e="ENVMAP_BLENDING_ADD";break}return e}function Md(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Sd(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=_d(t),l=gd(t),h=vd(t),f=xd(t),d=Md(t),m=ld(t),v=cd(s),x=r.createProgram();let p,u,b=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(fi).join(`
`)),a=Ls(a),a=Va(a,t),a=Ga(a,t),o=Ls(o),o=Va(o,t),o=Ga(o,t),a=ka(a),o=ka(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`)+`
`+u);const A=b+p+a,T=b+u+o,D=Ba(r,r.VERTEX_SHADER,A),P=Ba(r,r.FRAGMENT_SHADER,T);r.attachShader(x,D),r.attachShader(x,P),t.index0AttributeName!==void 0?r.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function w(C){if(i.debug.checkShaderErrors){const z=r.getProgramInfoLog(x)||"",G=r.getShaderInfoLog(D)||"",K=r.getShaderInfoLog(P)||"",W=z.trim(),q=G.trim(),$=K.trim();let H=!0,se=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(H=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,x,D,P);else{const ce=Ha(r,D,"vertex"),Ee=Ha(r,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
